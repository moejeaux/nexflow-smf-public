...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/db/client.ts [app-route] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '@/lib/redis'");
...
"[project]/src/app/api/v1/run/[endpointId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

// =============================================================================
// BILLABLE ENDPOINT ROUTE: POST /v1/run/:endpointId
// =============================================================================
// Metered endpoint execution with quota enforcement and billing
__turbopack_context__.s([
    "POST",
    ()=>POST
]);
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
async function POST(request, { params }) {
    ...
    // 2. Load endpoint and verify ownership
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
    const endpointResult = await db.query(`
    SELECT id, name, upstream_url, price_per_call, platform_fee_bps, account_id, status
    FROM endpoints
    WHERE id = $1
  `, [
        endpointId
    ...
    // Verify endpoint belongs to this account
    if (endpoint.account_id !== accountId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Endpoint not found',
            code: 'NOT_FOUND'
        }, {
    ...
    // 3. Load account plan limits
    const limits = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccountPlanLimits"])(accountId);
    if (!limits) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    // 4. Check and increment usage (quota enforcement)
    const usageCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkAndIncrementUsage"])(accountId, limits);
    if (!usageCheck.allowed) {
        // Log quota exceeded event
        const rated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateCall"])({
            pricePerCall: endpoint.price_per_call || '0.001',
            platformFeeBps: endpoint.platform_fee_bps || 200
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logBillingEvent"])({
            accountId,
            endpointId,
            status: 'quota_exceeded',
            pricePerCall: rated.pricePerCall,
            platformFeeBps: endpoint.platform_fee_bps || 200,
            platformCut: rated.platformCut,
            creatorNet: rated.creatorNet,
            errorMessage: usageCheck.reason
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'quota_exceeded',
            message: `You have exceeded your ${limits.name} plan quota. Upgrade your plan for higher limits.`,
            limits: {
    ...
    try {
        ...
        const authorization = request.headers.get('x-upstream-auth');
        if (authorization) headers['authorization'] = authorization;
        upstreamResponse = await fetch(endpoint.upstream_url, {
            method: 'POST',
            headers,
            body: body || undefined
        });
        ...
        upstreamError = err.message || 'Upstream request failed';
        upstreamStatusCode = 502;
    }
    const responseTime = Date.now() - startTime;
    // 7. Log billing event (regardless of upstream success)
    const billingStatus = upstreamStatusCode >= 200 && upstreamStatusCode < 300 ? 'success' : 'failed';
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logBillingEvent"])({
        accountId,
        endpointId,
        ...
        creatorNet: rated.creatorNet,
        upstreamStatusCode,
        upstreamResponseTimeMs: responseTime,
        errorMessage: upstreamError || undefined
    });
    // 8. Return response
    if (upstreamError) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67b1947f._.js.map