...
"[project]/src/lib/request-metrics.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// =============================================================================
// REQUEST METRICS
// =============================================================================
// Track request duration and latency percentiles per endpoint.
// Used by API routes to measure performance.
// =============================================================================
// TYPES
// =============================================================================
...
function cleanupOldMetrics() {
    ...
    // Remove endpoints not updated in the last hour
    const staleThreshold = now - CLEANUP_INTERVAL_MS;
    metrics.forEach((value, key)=>{
        if (value.lastUpdated < staleThreshold) {
            metrics.delete(key);
        }
    });
    lastCleanup = now;
...
function getPercentileStats(latencies) {
    ...
    return {
        p50: Math.round(calculatePercentile(sorted, 0.5)),
        p95: Math.round(calculatePercentile(sorted, 0.95)),
        p99: Math.round(calculatePercentile(sorted, 0.99)),
        avg: Math.round(sum / sorted.length),
        min: sorted[0],
        max: sorted[sorted.length - 1]
    };
}
function recordRequestDuration(endpoint, durationMs, isError = false) {
    cleanupOldMetrics();
    ...
    endpointMetrics.latencies.push(durationMs);
    if (endpointMetrics.latencies.length > MAX_SAMPLES) {
    ...
    endpointMetrics.lastUpdated = Date.now();
}
function createRequestTimer(endpoint) {
    const start = Date.now();
    return {
        end: (isError = false)=>{
            const duration = Date.now() - start;
            recordRequestDuration(endpoint, duration, isError);
            return duration;
        },
        elapsed: ()=>Date.now() - start
    };
}
function withRequestTiming(endpoint, handler) {
    return async (...args)=>{
        const timer = createRequestTimer(endpoint);
        try {
...
function getRequestMetrics() {
    ...
    metrics.forEach((value, key)=>{
        ...
        endpoints[key] = {
            ...
            latency: getPercentileStats(value.latencies)
        };
    });
    return {
        endpoints,
...
function getEndpointMetrics(endpoint) {
    ...
    return {
        ...
        errorRate: endpointMetrics.count > 0 ? (endpointMetrics.errors / endpointMetrics.count * 100).toFixed(2) + '%' : '0%',
        latency: getPercentileStats(endpointMetrics.latencies)
    };
}
...
"[project]/src/app/api/metrics/requests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

// =============================================================================
// GET /api/metrics/requests - Request Duration Metrics
// =============================================================================
// Returns request latency statistics per endpoint
__turbopack_context__.s([
    "GET",
    ()=>GET
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/request-metrics.ts [app-route] (ecmascript)");
...
async function GET(request) {
    ...
    // Check for specific endpoint filter
    const endpoint = request.nextUrl.searchParams.get('endpoint');
    if (endpoint) {
        const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEndpointMetrics"])(endpoint);
        if (!metrics) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    // Return all metrics
    const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRequestMetrics"])();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
        data: metrics,
        timestamp: new Date().toISOString()
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1de6d123._.js.map