...
"[project]/src/app/api/v1/billing/usage/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// 
// Get usage data for a customer (API key) for billing purposes
__turbopack_context__.s([
    "GET",
    ()=>GET
]);
...
async function GET(request) {
    const ctx = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$logging$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractRequestContext"])(request, '/api/v1/billing/usage');
    try {
        ...
        const periodTypeParam = searchParams.get('periodType') || 'monthly';
        const startDate = searchParams.get('startDate');
        const endDate = searchParams.get('endDate');
        const customerIdParam = searchParams.get('customerId');
        // Validate period type
        const periodTypeValidation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$endpoint$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validatePeriodType"])(periodTypeParam);
        if (!periodTypeValidation.valid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid period type',
                code: 'INVALID_PERIOD_TYPE',
                details: periodTypeValidation.errors
            }, {
                status: 400
            });
        }
        ...
        if (startDate || endDate) {
            const dateValidation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$endpoint$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateDateRange"])(startDate, endDate);
        ...
        // Get customer usage
        const usage = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2d$tracker$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCustomerUsage"])(customerId, period);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(usage);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d85d048._.js.map