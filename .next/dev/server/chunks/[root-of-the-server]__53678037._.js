...
"[project]/src/app/api/v1/auth/keys/[keyId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, { params }) {
    const { keyId } = await params; // Next.js 15+ requires awaiting params
    try {
        ...
        // TODO: Check ownership (users can only revoke their own keys unless admin)
        // For now, allow any authenticated user to revoke any key
        // In production, add ownership check
        const revoked = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$api$2d$keys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revokeApiKey"])(keyId);
        if (!revoked) {
        ...
        console.error('[auth/keys] Revoke error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__53678037._.js.map