...
"[project]/src/app/api/v1/endpoints/[endpointId]/summary/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

// =============================================================================
// ENDPOINT SUMMARY: GET /v1/endpoints/:endpointId/summary
// =============================================================================
// Returns basic usage + revenue summary for an endpoint this month
__turbopack_context__.s([
    "GET",
    ()=>GET
]);
...
async function GET(request, { params }) {
    ...
    // Verify endpoint exists and belongs to account
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
    const endpointResult = await db.query(`
    SELECT id, name, account_id, price_per_call, platform_fee_bps
    FROM endpoints
    WHERE id = $1
  `, [
        endpointId
    ...
    // Get billing summary
    const summary = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEndpointBillingSummary"])(endpointId, accountId);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true,
        endpoint: {
            id: endpoint.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__259f1eee._.js.map