...
"[project]/src/app/api/v1/billing/report/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// 
// Generate revenue and usage reports for billing periods
__turbopack_context__.s([
    "GET",
    ()=>GET
]);
...
async function GET(request) {
    const ctx = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$logging$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["extractRequestContext"])(request, '/api/v1/billing/report');
    try {
        // Require admin authentication for billing reports
        const authResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(request, 'admin');
        ...
        const endpointIdsParam = searchParams.get('endpointIds');
        const endpointIds = endpointIdsParam ? endpointIdsParam.split(',').map((id)=>id.trim()) : undefined;
        ...
        // Generate report
        const report = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2d$tracker$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateRevenueReport"])(period, endpointIds);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d066daaa._.js.map