...
const createEndpointSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    }, 'Price must be between 1 and 1000000000000000000'),
    ...
    }, 'Network must be a legacy name (e.g., "base") or CAIP-2 identifier (e.g., "eip155:8453")'),
    asset: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^0x[a-fA-F0-9]{40}$/, 'Asset must be a valid Ethereum address').or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^[a-zA-Z0-9_-]+$/, 'Asset must be alphanumeric')).or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^[a-z0-9]+:[a-z0-9]+\/[a-z0-9]+:[a-z0-9]+$/i, 'Asset must be a CAIP-19 identifier (e.g., "eip155:8453/erc20:0x...")')),
...
"[project]/src/lib/rate-limit-node.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

// =============================================================================
// Rate Limiting (Node.js Runtime)
// =============================================================================
// Node.js version that can access the database for API key-specific limits
// Use this in API routes (not middleware)
__turbopack_context__.s([
    "addRateLimitHeaders",
    ()=>addRateLimitHeaders,
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$api$2d$keys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function rateLimitByApiKey(request, defaultLimit = 1000) {
    ...
    // Find API key in database to get its rate limit
    let apiKey = null;
    try {
        apiKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$api$2d$keys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findApiKeyByToken"])(token);
    } catch (error) {
        console.error('[rate-limit] Failed to lookup API key:', error);
    // Fall back to default limit if lookup fails
    }
    const limit = apiKey?.rateLimit || defaultLimit;
...
function createRateLimitResponse(result, request, apiKeyId, route) {
    const resetDate = new Date(result.resetAt).toISOString();
    // Structured logging for rate limit events
    if (request) {
        const logger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$id$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createRequestLogger"])('rate-limit', {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2d$node$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/rate-limit-node.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2d$node$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$metered$2d$endpoints$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2d$node$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$logging$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function POST(request) {
    ...
    try {
        ...
        const rateLimitResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2d$node$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimitByApiKey"])(request);
        if (rateLimitResult && !rateLimitResult.allowed) {
            const response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2d$node$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createRateLimitResponse"])(rateLimitResult, request, ctx.apiKeyId, '/api/v1/endpoints');
        ...
        const { name, description, upstreamUrl, price, network = 'base', asset } = validation.data;
        // Additional validation for recipient address (required but not in schema)
        // This will be handled by the createEndpoint function
        const body = await request.json();
        ...
        const chainId = 8453;
        // Create endpoint (use API key ID as createdBy)
        ...
        if (rateLimitResult) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2d$node$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addRateLimitHeaders"])(response, rateLimitResult);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$request$2d$logging$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wrapResponse"])(response, ctx);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c97b0bfb._.js.map