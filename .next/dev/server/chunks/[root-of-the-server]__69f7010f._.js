...
"[project]/src/integrations/x402/facilitators/facilitator-probes.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$smf$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
 ...
 */ function buildProbeRequirements(facilitatorId, network, token) {
    const facilitator = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$x402$2f$facilitators$2f$facilitator$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FACILITATORS"][facilitatorId];
    if (!facilitator) {
 ...
 */ async function runProbe(config) {
    ...
    try {
        ...
        const { getFacilitatorRouter } = await __turbopack_context__.A("[project]/src/integrations/x402/facilitators/facilitator-router.ts [app-route] (ecmascript, async loader)");
...
async function startFacilitatorProbes() {
    ...
    // Double-check: never run in test environment
    ...
    logger.info({
        ...
        probes: PROBE_CONFIG.map((c)=>({
                facilitator: c.facilitatorId,
                network: c.network,
                token: c.token,
                intervalSeconds: c.intervalMs / 1000
            }))
    ...
    try {
        ...
        await __turbopack_context__.A("[project]/node_modules/@coinbase/cdp-sdk/_esm/auth/index.js [app-route] (ecmascript, async loader)");
        await __turbopack_context__.A("[project]/node_modules/viem/_esm/index.js [app-route] (ecmascript, async loader)");
        logger.info('Required dependencies (@coinbase/cdp-sdk/auth, viem) are available');
    } catch (error) {
        logger.warn({
    ...
    // Start all probe schedulers
    const intervals = PROBE_CONFIG.map((config)=>{
        try {
            return startProbeScheduler(config);
        } catch (error) {
            logger.error({
                error,
                config
            }, 'Failed to start probe scheduler for config');
            // Continue with other probes even if one fails
            return null;
        }
    }).filter((interval)=>interval !== null);
    logger.info({
        started: intervals.length,
        total: PROBE_CONFIG.length
    }, 'Facilitator probes started');
    return intervals;
}
...
"[project]/src/app/api/v1/smf/probes/status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

// =============================================================================
// SMF Probe Status API
// =============================================================================
// GET /api/v1/smf/probes/status
// Returns whether probes are enabled and their configuration
__turbopack_context__.s([
    "GET",
    ()=>GET
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$x402$2f$facilitators$2f$facilitator$2d$probes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/integrations/x402/facilitators/facilitator-probes.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$x402$2f$facilitators$2f$facilitator$2d$probes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$x402$2f$facilitators$2f$facilitator$2d$probes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
async function GET() {
    const env = ("TURBOPACK compile-time value", "development") || 'development';
    ...
    const probesEnabled = isProduction && enableProbes && !isTest;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        environment: {
            ...
            isProduction,
            isTest,
            enableProbesFlag: enableProbes
        },
        configuration: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null,
        message: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time truthy", 1) ? 'Probes disabled: not in production environment' : "TURBOPACK unreachable",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__69f7010f._.js.map